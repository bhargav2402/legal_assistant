...
const Docs = () => {
    ...
    const cardData = [
        { id: 1, title: 'Agreement Summary', icon: <AiOutlineFileSearch />, content: <DisplayOutput/> },
        { id: 2, title: 'Compare Agreements ', icon: <FaClipboardCheck />, content: 'Compare Agreements' },
        { id: 3, title: 'Document Translation ', icon: <TiDocumentAdd />, content: 'Document Translation' },
        { id: 4, title: 'Image to Text ', icon: <AiOutlineTranslation />, content: <ImageAnalysis /> }, // Embed ImageAnalysis component here
      ];
  
    return (
      <div className="flex h-[100vh] bg-gray-900 text-white" style={{scrollbarWidth:'1px'}}>
