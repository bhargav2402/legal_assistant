  ...
  return (
    <div
      className={`mb-2 rounded p-5 ${
        author === "You" ? "bg-gray-700" : "bg-gray-600"
      }`}
    >
      <div className="font-bold flex items-center gap-2 text-xl text-gray-300">
        {" "}
...
export const ChatArea = ({
  ...
  return (
    <div className="flex-1 lg:mx-36 mx-5 overflow-y-auto p-4 bg-gray-800">
      <AnimatePresence>
          ...
          <div className="flex flex-col h-full items-center justify-between">
            ...
            <div className="flex flex-col gap-6 items-center">
              ...
              <motion.div
                ...
                exit={{ opacity: 0 }}
                transition={{ duration: 0.6 }}
                className="font-semibold text-lg md:text-2xl mb-2 text-gray-300"
              >
              ...
              {randomPrompts.map((prompt, index) => (
                <AnimatePresence key={index}>
                  <motion.div
                    ...
                    className="text-sm lg:p-4 p-3 cursor-pointer transition-all duration-300 hover:shadow-md rounded-lg border border-gray-600 bg-gray-700 text-gray-300"
                    onClick={() => handlePrompt(prompt.heading, prompt.addition)}
                  >
