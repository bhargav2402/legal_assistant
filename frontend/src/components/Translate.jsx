  ...
  return (
    <div className="min-h-screen bg-gray-800 text-gray-300 flex flex-col items-center justify-center p-8">
      ...
      <input
        ...
        accept=".jpg, .jpeg, .png"
        className="mb-4 px-4 py-2 border border-gray-600 rounded-md"
      />
      {output && (
        <div className="mt-8 p-6 bg-gray-700 rounded-md">
          ...
          <div className="mt-4 flex items-center">
            ...
            <select
              ...
              className="border border-gray-600 rounded p-1 bg-gray-800 text-gray-300"
            >
            ...
            <button
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded ml-2 transition-colors duration-300"
              disabled={isLoading}
            >
