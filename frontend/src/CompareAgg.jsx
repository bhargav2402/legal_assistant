...
function CompareAgg() {
  ...
  return (
    <div className="min-h-[91vh] bg-gray-100 text-gray-800 flex flex-col items-center justify-center p-8">
      ...
      <div className="mt-8 w-full max-w-4xl p-6 bg-white rounded-md shadow-md overflow-auto whitespace-pre-wrap">
